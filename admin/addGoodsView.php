	...
	<div class="finance-content clearfix">
		...
		<div class="finance-content-middle">
			...
			<div class="finance-content-middle-form">
				<form  action="addGoods.php" method="post" enctype="multipart/form-data" autocomplete="off">
					<div class="finance-add-agent finance-add-agent-ad">
						<p>
							<label><em>*</em>商品名称：</label>
							<input type="text" name="g_name" value="" placeholder="请输入商品名称" maxlength="100">
						</p>
						<p>
						...
						<p>
							...
							<input type="text" name="type2" value="" placeholder="请输入商品所属小类" maxlength="15">
						</p>
						<p>
							<label><em>*</em>价格：</label>
							<input type="text" name="price" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"  value="" placeholder="请输入商品价格">
						</p>
						<p>
							<label>产品介绍：</label>
							<textarea class="form-control"  id="describe" name="describe" rows="10" style="width: 700px !important;"></textarea>
						</p>
